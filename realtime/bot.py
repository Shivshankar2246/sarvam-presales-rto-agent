...
def build_system_prompt(ctx: dict) -> str:
    ...
    return (
        ...
        f"- No cash right now / would rather pay online: offer to lock the order by paying now on a "
        f"UPI link you send on WhatsApp, and sweeten it (free shipping, ships today) so it's an easy yes.\n"
